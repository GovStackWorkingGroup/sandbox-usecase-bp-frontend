  ...
  return (
    <Flex direction="column" flexGrow={1}>
      ...
      <Flex direction="column" gap="20px">
        <Heading variant="display">Application Submitted Successfully</Heading>
        <Text color="grey" fontWeight="semibold">
          Application #987654
        </Text>
        <Text >
        Your application has been successfully submitted and is now under review by our team.
        </Text>
          ...
          <AccordionItem title="1. Application Review">
            <>
              <Text>
                ...
                You can track down your applications via <Link as={RouterLink} to="/" textColor={colors.theme.primary}>My Construction Permit Applications</Link> page.<br /><br />
