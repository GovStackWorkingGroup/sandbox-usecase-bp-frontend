...
import { Button, Flex, ListItem, Spacer, Text, UnorderedList } from "@chakra-ui/react";
...
export default function ApplicationAction({
  ...
  action: "inReview" | "scheduleInspection" | "upcomingInspection" | "documentsRequired" | "paymentRequired" | string
  id?: string;
